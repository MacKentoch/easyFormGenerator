                              ...
                              [

                                {
                                  'label': [  
                                            ...
                                            '  </label>',
                                            '  <div class="">',
                                            '    <input type="text" dd-no-editable-control class="form-control" id="inputText" placeholder="basic input">',
                                ...
                                },                              
                                {
                                  ...
                                  'label': [
                                            ...
                                            '  </label>',
                                            '  <div class="">',
                                            '    <input type="password" dd-no-editable-control class="form-control" id="inputText" placeholder="password input">',
                              ...
                              [

                                {
                                  'label': [
                                              ...
                                              '      <div class="">',
                                              '        <textarea class="form-control dd-no-editable-control dragItemtextarea" ng-model="model[options.key]" rows="1" id="textArea"></textarea>',
                                              '        <p class="help-block pull-left">description</p>',          
                                              '      </div>',
                                              '    </div>',                    
                                              '</div>'                                  
                              ...
                              [
                                {
                                  'label' : [
                                              ...
                                              '      <div class="radio">',
                                              '        <label class="">',
                                              '          <input type="radio" dd-no-editable-control name="optionsRadios" id="optionsRadio-0" value="verticalRadio0" checked="">',
                                              '          option1',
                                              '        </label>',
                                              '      </div><div class="radio">',
                                              '        <label class="">',
                                              '          <input type="radio" dd-no-editable-control name="optionsRadios" id="optionsRadio-1" value="verticalRadio1" checked="">',
                                              '          option2',
                                              '        </label>',
                                              '      </div>',
                                              '      <p class="help-block pull-left">description</p>',
