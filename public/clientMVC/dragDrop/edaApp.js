...
angular
  ...
  function runfct($templateCache){
  		...
  		function editPanelHeaderCtrlTpl(){
			 ...
			 * control : "radio"
			 */
			$templateCache.put('editPanelRadioCtrl-tpls.html', 
												[
													'<div class="panel panel-default">',
													'    <div class="panel-body">',
			 ...
			 */
			$templateCache.put('editPanelBasicSelectCtrl-tpls.html', 
												[
													'<div class="panel panel-default">',
													'    <div class="panel-body">',
			 ...
			 */
			$templateCache.put('editPanelGroupedSelectCtrl-tpls.html', 
												[
													'<div class="panel panel-default">',
													'    <div class="panel-body">',
