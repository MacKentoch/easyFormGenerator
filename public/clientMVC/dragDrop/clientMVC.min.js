    ...
    .directive('edaRightClick', [
    	...
    	return {
    		...
    		link: function(scope, element, attrs) {
                ...
                //     angular.element(element).removeClass(currentClass);

                //     if (value === true) angular.element(element).addClass(currentClass);
                //     if (value === false) angular.element(element).removeClass(currentClass);
