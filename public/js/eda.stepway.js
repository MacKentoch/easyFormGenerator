			...
			function easyFormSteWayConfig($translate){
				...
				function switchLanguage(language){
					...
					if (angular.isString(language)) {
						...
						console.info('should be set to ' + language);
					}else{
						setDefaultLanguage();
					}
				}				
