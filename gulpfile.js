...
var paths = {
 ...
 bower_components_js: 	[
						...
						'bower_components/angular-code-mirror/dist/angular-code-mirror.min.js'
 					],
bower_components_map: 	[
							...
							'bower_components/zeroclipboard/dist/ZeroClipboard.min.map'
						], 					
...
bower_components_fonts: [
 ...
 js_lib: [''],
 swfFile: ['bower_components/zeroclipboard/dist/ZeroClipboard.swf']
};
...
//copy bower APP -> app/public/lib/js	
 ...
 // swf : need it to copy clipboard (ng-clip)
 gulp.src(paths.swfFile, {cwd: bases.app })
 .pipe(gulp.dest(bases.app + 'public/lib/swf/'))
