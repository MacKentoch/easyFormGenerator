...
const isProd = ENV === 'build-prod-stepway';
...
module.exports = function makeWebpackConfig () {
  ...
  config.output = isTest ? {} : {
    ...
    filename: isProd ? 'eda.stepway.min.js' : 'eda.stepway.js',

    // Filename for non-entry points
    // Only adds hash in build mode
    chunkFilename: isProd ? 'eda.stepway.[hash].js' : 'eda.stepway.bundle.js',
  ...
  config.module = {
    preLoaders: [{
        ...
        include: path.join(__dirname, '/src/app/stepway')
    }],
    loaders: [{
      // JS LOADER
