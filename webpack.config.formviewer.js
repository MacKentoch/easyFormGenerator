...
const isProd = ENV === 'build-prod-formviewer';
...
module.exports = function makeWebpackConfig () {
  ...
  config.output = isTest ? {} : {
    ...
    filename: isProd ? 'eda.easyFormViewer.min.js' : 'eda.easyFormViewer.js',

    // Filename for non-entry points
    // Only adds hash in build mode
    chunkFilename: isProd ? 'eda.easyFormViewer.[hash].js' : 'eda.easyFormViewer.bundle.js',
  ...
  if (!isTest && !isProd) {
    ...
    config.plugins.push(
      ...
      new ExtractTextPlugin('eda.formviewer.css')
    );
  }
